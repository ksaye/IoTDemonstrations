...
*/
const string BlobConnectionString = "DefaultEndpointsProtocol=https;AccountName=january2017;AccountKey=MFREMOVEDXA8aWIyg==";
...
const string CognitiveKey = "c7REMOVEDcc";
const string CognitiveGroupId = "jaREMOVED17";
const string TwilioAccountSid = "AREMOVEDdd";
const string TwilioAuthToken = "4cREMOVEDe9e";
const string fromPhoneNumber = "+14REMOVED2";
const string toPhoneNumber = "+121REMOVED81";
...
public static async Task Run(string myEventHubMessage, TraceWriter log)
{
    ...
    if (msg.action == "verifyPicture()")
    {
        ...
        if (imageInfo != "[]")
        {
            string stringIdentify = "{\"personGroupId\":\"" + CognitiveGroupId + "\",\"faceIds\":[\"" + face.faceId + "\"],\"maxNumOfCandidatesReturned\":1,\"confidenceThreshold\":0.5}";
